...
type DefsMapi = {
    ...
    adb: {
        ...
        adbShell: (args: string[], deviceId?: string | undefined) => Promise<string>;
        connect: (host: string, port: number) => Promise<void>;
        connectUSB: (id: string) => Promise<void>;
        disconnectUSB: (id: string) => Promise<void>;
        disconnect: (host: string, port: number) => Promise<void>;
        disconnectByShell: (deviceId: string) => Promise<void>;
        forwardPort: (host: string, port: number) => Promise<void>;
        removeForwardPort: (host: string, port: number) => Promise<void>;
